...
<div class="bs-stepper">
    <div class="bs-stepper-header" role="tablist">
        <!-- your steps here -->
        <div class="step active" data-target="#register-part">
            <button type="button" class="step-trigger" role="tab" aria-controls="register-part" id="register-trigger" aria-selected="true">
        ...
        <div class="step" data-target="#pricing-part">
            <button type="button" class="step-trigger" role="tab" aria-controls="pricing-part" id="pricing-part-trigger" aria-selected="false" disabled="disabled">
                        ...
                        <form id="tilmeldingForm" class="row g-5 fs-4 fw-bold" action="{{ route('tilmelding.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 pb-5 align-self-center text-center">
                                    ...
                                    <div class="input-group-lg mb-4">
                                        <select class="form-select fs-5 fw-bold" required="required" name="address">
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group-lg mb-4">
                                    ...
                                    <input type="password" class="form-control" id="confirm_password" required="required" name="password_confirmation">
                                </div>
                            ...
                            <div class="col-6">
                                <div class="input-group-lg">
                                    ...
                                    <textarea class="form-control" id="resume" rows="14" name="resume" required="required"></textarea>
                                </div>    
                            </div> 
